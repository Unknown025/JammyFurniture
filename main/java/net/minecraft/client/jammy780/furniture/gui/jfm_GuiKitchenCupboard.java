...
public class jfm_GuiKitchenCupboard extends GuiContainer
{
	private IInventory upperChestInventory;
	private IInventory lowerChestInventory;
	private int inventoryRows;

	public jfm_GuiKitchenCupboard(IInventory par1IInventory, IInventory par2IInventory)
	{
		super(new jfm_ContainerKitchenCupboard(par1IInventory, par2IInventory));
