...
import net.minecraft.jammy780.furniture.model.sofa.jfm_ModelSofaRight;
...
public class jfm_SofaRightRenderer extends TileEntitySpecialRenderer implements ISimpleBlockRenderingHandler
{
	private jfm_ModelSofaRight sofa_right;
	...
	public jfm_SofaRightRenderer()
	{
		this.sofa_right = new jfm_ModelSofaRight();
	}

	public void renderAModel(jfm_TileEntitySofaRight tileentity1, double d, double d1, double d2, float f)
	{
		int ac1_rot = 0;
		int ac2_rot = 0;
		int ac3_rot = 0;
		...
		case 3: 
			...
			GL11.glPushMatrix();
			this.sofa_right.renderModel(0.0625F);
			GL11.glPopMatrix();
			GL11.glPopMatrix();
			break;
		case 4: 
	...
	public void renderTileEntityAt(TileEntity tileentity, double d, double d1, double d2, float f)
	{
		if (tileentity.getWorldObj() == null) {
			...
			renderAModel((jfm_TileEntitySofaRight)tileentity, d, d1, d2, f);
		}
	}
	...
	{
		renderTileEntityAt(new jfm_TileEntitySofaRight(metadata), 0.0D, -0.1D, 0.0D, 0.0F);
	}
