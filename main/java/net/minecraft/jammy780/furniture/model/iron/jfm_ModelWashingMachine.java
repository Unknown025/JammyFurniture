...
public class jfm_ModelWashingMachine
  extends ModelBase
{
  ModelRenderer Base;
  ...
  public jfm_ModelWashingMachine()
  {
    ...
    setRotation(this.DoorMain, 0.0F, 0.0F, 0.0F);
    ...
    setRotation(this.DoorBottom, 0.0F, 0.0F, 0.0F);
    ...
    setRotation(this.DoorTop, 0.0F, 0.0F, 0.0F);
