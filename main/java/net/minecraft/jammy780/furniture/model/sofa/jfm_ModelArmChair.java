package net.minecraft.jammy780.furniture.model.sofa;

import net.minecraft.client.model.ModelBase;
import net.minecraft.client.model.ModelRenderer;
import net.minecraft.entity.Entity;

public class jfm_ModelArmChair
  extends ModelBase
{
  ...
  public jfm_ModelArmChair()
  {
    ...
    setRotation(this.ChairSideR, 0.0F, 0.0F, 0.0F);
    ...
    setRotation(this.ChairSideTopR, 0.0F, 0.0F, 0.0F);
    ...
    setRotation(this.ChairSideL, 0.0F, 0.0F, 0.0F);
    ...
    setRotation(this.ChairSideTopL, 0.0F, 0.0F, 0.0F);
    ...
    setRotation(this.Cushion, 0.0F, 0.0F, 0.0F);
  }
