...
public class jfm_ModelChimney extends ModelBase
{
	...
	public jfm_ModelChimney()
	{
		...
		setRotation(this.ChimneyBase, 0.0F, 0.0F, 0.0F);
		...
		setRotation(this.ChimneyMid, 0.0F, 0.0F, 0.0F);
		...
		setRotation(this.ChimneyMid3, 0.0F, 0.0F, 0.0F);
		...
		setRotation(this.ChimneyMid2, 0.0F, 0.0F, 0.0F);
		...
		setRotation(this.ChimneyTop1, 0.0F, 0.0F, 0.0F);
		...
		setRotation(this.ChimneyTop2, 0.0F, 0.0F, 0.0F);
		...
		setRotation(this.ChimneyTop3, 0.0F, 0.0F, 0.0F);
		...
		setRotation(this.ChimneyTop4, 0.0F, 0.0F, 0.0F);
	}
