...
public class jfm_MobHeadsTwo extends BlockContainer
{
	public jfm_MobHeadsTwo(String name, int notsure, Class teClass)
	{
		super(Material.cloth);
		setBlockName(name);
		setBlockTextureName("jammyfurniture:jammy_cloth");
		setCreativeTab(JammyFurnitureModCore.jfmCustomTab);
		GameRegistry.registerBlock(this, jfm_ItemMobHeadsTwo.class, name);
	}
	...
	public AxisAlignedBB getCollisionBoundingBoxFromPool(World par1World, int par2, int par3, int i)
	{
		...
		if (b == 0) {
			setBlockBounds(0.25F, 0.25F, 0.425F, 0.75F, 0.75F, 1.0F);
		} else if (b == 1) {
			setBlockBounds(0.0F, 0.25F, 0.25F, 0.575F, 0.75F, 0.75F);
		} else if (b == 2) {
			setBlockBounds(0.25F, 0.25F, 0.0F, 0.75F, 0.75F, 0.575F);
		} else if (b == 3) {
			setBlockBounds(0.425F, 0.25F, 0.25F, 1.0F, 0.75F, 0.75F);
		} else if (b == 4) {
			setBlockBounds(0.3F, 0.25F, 0.625F, 0.7F, 0.625F, 1.0F);
		} else if (b == 5) {
			setBlockBounds(0.0F, 0.25F, 0.3F, 0.375F, 0.625F, 0.7F);
		} else if (b == 6) {
			setBlockBounds(0.3F, 0.25F, 0.0F, 0.7F, 0.625F, 0.375F);
		} else if (b == 7) {
			setBlockBounds(0.625F, 0.25F, 0.3F, 1.0F, 0.625F, 0.7F);
		} else if (b == 8) {
	...
	public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer entityplayer, int par6, float par7, float par8, float par9)
	{
		...
		{
			par1World.playSound(par2, par3, par4, "mob.pig.say", 1.0F, 1.0F, true);
			return true;
		}
		if ((meta == 4) || (meta == 5) || (meta == 6) || (meta == 7))
		{
			par1World.playSound(par2, par3, par4, "mob.sheep.say", 1.0F, 1.0F, true);
			return true;
		}
		if ((meta == 8) || (meta == 9) || (meta == 10) || (meta == 11))
		{
			par1World.playSound(par2, par3, par4, "mob.skeleton.say", 1.0F, 1.0F, true);
			return true;
		}
		if ((meta == 12) || (meta == 13) || (meta == 14) || (meta == 15))
		{
			par1World.playSound(par2, par3, par4, "mob.spider.say", 1.0F, 1.0F, true);
			return true;
		}
		return true;
	}
