...
public class jfm_BlockSofaCenter extends BlockContainer
{
	...
	public jfm_BlockSofaCenter(String name, int notsure, Class teClass)
	{
		super(Material.wood);
		setBlockName(name);
		setCreativeTab(JammyFurnitureModCore.jfmCustomTab);
		GameRegistry.registerBlock(this, jfm_ItemSofaCenter.class, name);
	}
	...
	{
		return JammyFurnitureModCore.sofaPartCenterRenderID;
	}
	...
	{
		return new jfm_TileEntitySofaCenter();
	}
