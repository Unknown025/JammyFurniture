...
public class jfm_BlockSofaRight extends BlockContainer
{
	...
	public jfm_BlockSofaRight(String name, int notsure, Class teClass)
	{
		super(Material.wood);
		setBlockName(name);
		setCreativeTab(JammyFurnitureModCore.jfmCustomTab);
		GameRegistry.registerBlock(this, jfm_ItemSofaRight.class, name);
	}
