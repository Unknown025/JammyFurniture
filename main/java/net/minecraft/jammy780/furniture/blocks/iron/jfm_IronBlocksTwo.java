...
public class jfm_IronBlocksTwo extends BlockContainer
{
	...
	public jfm_IronBlocksTwo(String name, int notsure, Class teClass)
	{
		super(Material.iron);
		...
		GameRegistry.registerBlock(this, jfm_ItemIronBlocksTwo.class, name);
	}
	...
	public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer entityplayer, int par6, float par7, float par8, float par9)
	{
		...
		{
			jfm_TileEntityIronBlocksTwo teIronTwo = (jfm_TileEntityIronBlocksTwo)par1World.getTileEntity(par2, par3, par4);
			if (teIronTwo != null)
			{
	...
	{
		jfm_TileEntityIronBlocksTwo te = (jfm_TileEntityIronBlocksTwo)par1World.getTileEntity(par2, par3, par4);
		if (te != null)
		{
