...
public class jfm_ArmChairRenderer extends TileEntitySpecialRenderer implements ISimpleBlockRenderingHandler
{
	private jfm_ModelArmChair arm_chair;
	...
	public jfm_ArmChairRenderer()
	{
		this.arm_chair = new jfm_ModelArmChair();
	}
	...
	public void renderTileEntityAt(TileEntity tileentity, double d, double d1, double d2, float f)
	{
		...
		{
			renderAModel((jfm_TileEntityArmChair)tileentity, d, d1, d2, f);
		}
	}
	...
	{
		renderTileEntityAt(new jfm_TileEntityArmChair(metadata), 0.0D, -0.1D, 0.0D, 0.0F);
	}
