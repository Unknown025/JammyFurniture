...
import net.minecraft.jammy780.furniture.model.sofa.jfm_ModelSofaCorner;
...
public class jfm_SofaCornerRenderer extends TileEntitySpecialRenderer implements ISimpleBlockRenderingHandler
{
	private jfm_ModelSofaCorner sofa_corner;

	protected static final ResourceLocation textureRed = new ResourceLocation("jammyfurniture:" + jfm_ConfigDefault.TEXTURE_PATH + "jammy_sofacorner_red.png");
	protected static final ResourceLocation textureBlue = new ResourceLocation("jammyfurniture:" + jfm_ConfigDefault.TEXTURE_PATH + "jammy_sofacorner_blue.png");
	...
	public jfm_SofaCornerRenderer()
	{
		this.sofa_corner = new jfm_ModelSofaCorner();
	}
	...
	public void renderAModel(jfm_TileEntitySofaCorner tileentity1, double d, double d1, double d2, float f)
	{
		...
		case 3: 
			...
			GL11.glPushMatrix();
			this.sofa_corner.renderModel(0.0625F);
			GL11.glPopMatrix();
			GL11.glPopMatrix();
			break;
		case 4: 
	...
	public void renderTileEntityAt(TileEntity tileentity, double d, double d1, double d2, float f)
	{
		if (tileentity.getWorldObj() == null) {
			...
			renderAModel((jfm_TileEntitySofaCorner)tileentity, d, d1, d2, f);
		}
	}
	...
	{
		renderTileEntityAt(new jfm_TileEntitySofaCorner(metadata), 0.0D, -0.1D, 0.0D, 0.0F);
	}
