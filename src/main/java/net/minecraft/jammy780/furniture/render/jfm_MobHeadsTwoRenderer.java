...
import net.minecraft.jammy780.furniture.model.heads.jfm_ModelPigHead;
import net.minecraft.jammy780.furniture.model.heads.jfm_ModelSheepHead;
...
public class jfm_MobHeadsTwoRenderer extends TileEntitySpecialRenderer implements ISimpleBlockRenderingHandler

{
	private jfm_ModelPigHead pig_head;
	private jfm_ModelSheepHead sheep_head;
	...
	public jfm_MobHeadsTwoRenderer()
	{
		this.pig_head = new jfm_ModelPigHead();
		this.sheep_head = new jfm_ModelSheepHead();
	...
	public void renderTileEntityAt(TileEntity tileentity, double d, double d1, double d2, float f)
	{
		if (tileentity.getWorldObj() == null) {
			...
			renderAModel((jfm_TileEntityMobHeadsTwo)tileentity, d, d1, d2, f);
		}
	}
	...
	{
		renderTileEntityAt(new jfm_TileEntityMobHeadsTwo(metadata), 0.0D, 0.4D, 0.2D, 0.0F);
	}
