...
public class jfm_ModelTableLamp
  extends ModelBase
{
  ModelRenderer Base;
  ...
  public jfm_ModelTableLamp()
  {
    ...
    setRotation(this.BaseProp, 0.0F, 0.0F, 0.0F);
    ...
    setRotation(this.ShadeSide1, 0.0F, 0.0F, 0.0F);
    ...
    setRotation(this.ShadeSide2, 0.0F, 0.0F, 0.0F);
    ...
    setRotation(this.ShadeSide3, 0.0F, 0.0F, 0.0F);
    ...
    setRotation(this.ShadeSide4, 0.0F, 0.0F, 0.0F);
