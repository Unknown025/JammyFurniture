...
public class jfm_BlockArmChair extends BlockContainer
{
	...
	public jfm_BlockArmChair(String name, int notsure, Class teClass)
	{
		super(Material.wood);
		setBlockName(name);
		setCreativeTab(JammyFurnitureModCore.jfmCustomTab);
		GameRegistry.registerBlock(this, jfm_ItemArmChair.class, name);
	}
	...
	{
		return JammyFurnitureModCore.armChairRenderID;
	}
	...
	{
		return new jfm_TileEntityArmChair();
	}*/
