...
public class jfm_MobHeadsOne extends BlockContainer
{
	public jfm_MobHeadsOne(String name, int notsure, Class teClass)
	{
		super(Material.cloth);
		setBlockName(name);
		setBlockTextureName("jammyfurniture:jammy_cloth");
		setCreativeTab(JammyFurnitureModCore.jfmCustomTab);
		GameRegistry.registerBlock(this, jfm_ItemMobHeadsOne.class, name);
	}
	...
	public AxisAlignedBB getCollisionBoundingBoxFromPool(World par1World, int par2, int par3, int i)
	{
		...
		if (b == 0) {
			setBlockBounds(0.3F, 0.3F, 0.6F, 0.7F, 0.8F, 1.0F);
		} else if (b == 1) {
			setBlockBounds(0.0F, 0.3F, 0.3F, 0.4F, 0.8F, 0.7F);
		} else if (b == 2) {
			setBlockBounds(0.3F, 0.3F, 0.0F, 0.7F, 0.8F, 0.4F);
		} else if (b == 3) {
			setBlockBounds(0.6F, 0.3F, 0.3F, 1.0F, 0.8F, 0.7F);
		} else if (b == 4) {
			setBlockBounds(0.25F, 0.25F, 0.625F, 0.75F, 0.75F, 1.0F);
		} else if (b == 5) {
			setBlockBounds(0.0F, 0.25F, 0.25F, 0.375F, 0.75F, 0.75F);
		} else if (b == 6) {
			setBlockBounds(0.25F, 0.25F, 0.0F, 0.75F, 0.75F, 0.375F);
		} else if (b == 7) {
			setBlockBounds(0.625F, 0.25F, 0.25F, 1.0F, 0.75F, 0.75F);
		} else if (b == 8) {
			...
			setBlockBounds(0.2F, 0.05F, 0.1F, 0.8F, 0.75F, 1.0F);
		} else if (b == 13) {
			setBlockBounds(0.0F, 0.05F, 0.2F, 0.9F, 0.75F, 0.8F);
		} else if (b == 14) {
			setBlockBounds(0.2F, 0.05F, 0.0F, 0.8F, 0.75F, 0.9F);
		} else if (b == 15) {
			setBlockBounds(0.1F, 0.05F, 0.2F, 1.0F, 0.75F, 0.8F);
		} else {
	...
	public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer entityplayer, int par6, float par7, float par8, float par9)
	{
		...
		{
			par1World.playSound(par2, par3, par4, "mob.chicken.say", 1.0F, 1.0F, true);
			return true;
		}
		if ((meta == 4) || (meta == 5) || (meta == 6) || (meta == 7))
		{
			par1World.playSound(par2, par3, par4, "mob.cow.say", 1.0F, 1.0F, true);
			return true;
		}
		if ((meta == 8) || (meta == 9) || (meta == 10) || (meta == 11))
		{
			par1World.playSound(par2, par3, par4, "random.fuse", 1.0F, 1.0F, true);
			return true;
		}
		return true;
	}
	...
	{
		return JammyFurnitureModCore.mobHeadsOneRenderID;
	}
	...
	{
		return new jfm_TileEntityMobHeadsOne();
	}
